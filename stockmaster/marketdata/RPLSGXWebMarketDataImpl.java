...
public class RPLSGXWebMarketDataImpl extends MarketData {
	...
	public RPLSGXWebMarketDataImpl(String folder, String date, String market) {
		selectedDate = date;
		selectedMarket = market;
		selectedFolder = folder;
	}

	public RPLSGXWebMarketDataImpl(int refreshTime) {
		super(refreshTime);
